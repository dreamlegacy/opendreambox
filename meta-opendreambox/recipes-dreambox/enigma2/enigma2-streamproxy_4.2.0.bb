...
SRC_URI = "file://streamproxy@.service \
...
do_install_append() {
    ...
    ln -sf /dev/null ${D}${systemd_system_unitdir}/streamproxy.service
    install -m644 ${WORKDIR}/streamproxy@.service ${D}${systemd_system_unitdir}
    install -m644 ${WORKDIR}/streamproxy.socket ${D}${systemd_system_unitdir}
}
